...
public class TestCadastroUsuarioOuEmpresaFisicaCpfJaExistente {
  ...
  @Test
  public void testCadastroUsuarioOuEmpresaFisicaCpfJaExistente() throws Exception {
    driver.get(baseUrl + "/");
    ...
    assertEquals("CPF/CNPJ já cadastrado. Erro ao cadastrar!",driver.findElement(By.cssSelector("body > div > div.alert.alert-danger")).getText());
